...
import PubliiVideos from './default-blocks/publii-videos/block.vue';
import PubliiCards from './default-blocks/publii-cards/block.vue';
...
export default {
  ...
  components: {
    ...
    'publii-cards': PubliiCards,
    'publii-videos': PubliiVideos,
